...
// This file preserves the retired queue-coupled Instagram repost path for reference only.
// The live app no longer loads this file.
...
function getThumbnailService() {
  ...
  try {
    _thumbnailService = require('../../services/thumbnailService');
  } catch (e) {
